...
import com.codehub.marvelheroesapp.Adapters.HeroAdapt;
...
public class FirstFragment extends Fragment {
    ...
    private HeroAdapt heroAdapt;
    private List<HeroesModel> heroes;
    private ArrayList<HeroesModel> heroesModels = new ArrayList<>();
...
//        View root =  inflater.inflate(R.layout.fragment_first, container, false);
        ...
        //heroAdapt = new HeroAdapt(getContext(), heroes);
//        RecyclerView recyclerView = root.findViewById(R.id.recycler_view_for_all);
//        recyclerView.setHasFixedSize(true);
//        recyclerView.setAdapter( new HeroAdapt(heroesModels, getActivity()));
            ...
            StringRequest stringRequest7= new StringRequest(Request.Method.GET, JSON_URL7, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        heroAdapt = new HeroAdapt(getContext(), heroes);
                        recyclerView.setAdapter(heroAdapt);
