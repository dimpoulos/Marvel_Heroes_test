package com.codehub.marvelheroesapp.ELEOS;
...
public class FavDB extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME ="FavoriteHero";
    ...
    public void insertIntoTheDatabase(String item_title, ImageModel item_image, Integer id, String fav_status){
        SQLiteDatabase db;
        db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(ITEM_TITLE, item_title);
        cv.put(ITEM_IMAGE, String.valueOf(item_image));
        cv.put(KEY_ID, id);
    ...
    public Cursor read_all_data (Integer id){
        SQLiteDatabase db = this.getReadableDatabase();
        String sql = "select * from " + TABLE_NAME + " where " + KEY_ID + "=" +id+"";
        return db.rawQuery(sql, null, null);
    }

    public void remove_fav (Integer id) {
        SQLiteDatabase db = this.getWritableDatabase();
